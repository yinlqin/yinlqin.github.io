...
<div id="layerDemo">
      ...
      <button type="submit" id="rukuguanli_xinjianw" class="layui-btn">新建入库单</button>
      </div>
 </div>
 ...
 <table class="layui-G-table">
   <thead>
     ...
     while ($data=mysqli_fetch_assoc($result)){
      ...
      //  $edi_url=urlencode("qf_rk_rukudan_liebiao.php?id={$data['ru_id']}");
$html=<<<A
    <tr>
    <td>{$data['ru_id']}</td>
...
A;
 ...
 <script>
 //入库管理界面的添加按钮
$('#rukuguanli_xinjianw').on('click', function(){
layer.open({
