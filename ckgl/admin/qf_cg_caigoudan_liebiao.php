...
<form class="layui-form" action="">
  <div class="layui-form-item">
    <label class="layui-form-label">采购状态选择</label>
    <div class="layui-input-block" style="width: 300px;">
      <input type="radio" name="caigou_zhuangtai" value="未采购" title="未采购" checked="">
      <input type="radio" name="caigou_zhuangtai" value="已采购" title="已采购">
    </div>
    <label class="layui-form-label">入库状态选择</label>
    <div class="layui-input-block">
      <input type="radio" name="ruku_zhuangtai" value="未入库" title="未入库" checked="">
      <input type="radio" name="ruku_zhuangtai" value="未完全入库" title="未完全入库">
      <input type="radio" name="ruku_zhuangtai" value="完全入库" title="完全入库">
    </div>
    <br>
  </div>  
  <div class="layui-form-item">
...
<div id="layerDemo">
 ...
 <table class="layui-G-table">
   <thead>
     <tr>
       <th style="width: 45px;">父单号</th>
       <th style="width: 45px;">子单号</th>
       <th style="width: 40px;">物料编码</th>
       <th style="width: 40px;">物料类别</th>
       <th>物料名称</th>
       <th>品牌</th>
       <th>规格型号</th>
       <th>材质</th>
       ...
       <th>请购用途</th>
       <th>需求日期</th>
       <th style="width: 40px;">采购状态</th>
       <th style="width: 40px;">入库状态</th>
       <th>操作</th>
     </tr>
     <?php
...
$html=<<<A
    ...
    <td>{$data['caigou_zhuangtai']}</td>
    <td>{$data['ruku_zhuangtai']}</td>
    <td>
    <a href="qf_cg_caikudan_liebiao_del.php?cgd_id={$data['cgd_id']}" style="color: #0095ff;">采购</a>
    &nbsp&nbsp;
    <a href="qf_cg_caikudan_liebiao_del.php?cgd_id={$data['cgd_id']}" style="color:#f00">删除</a></td>
    </tr>
A;
        echo $html;
        }}
